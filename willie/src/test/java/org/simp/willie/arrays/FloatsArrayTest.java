...
public class FloatsArrayTest {
    ...
    @Before
    public void setUp() {
        mArray = new float[]{1.0f, 2.0f, 3.0f, 4.0f};
    }

    @Test(expected = IllegalArgumentException.class)
    public void testWrap_NullPointerException() {
        FloatsArray.wrap(null);
    }
    ...
    public void testWrap_UsesSameArray() {
        ...
        final FloatsArray data = FloatsArray.wrap(mArray);

        mArray[0] = 2.0f;

        assertThat(data.itemAt(0), equalTo(2.0f));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testCopy_NullPointerException() {
        FloatsArray.copy(null);
    }
    ...
    public void testCopy_CreateNewArray() {
        ...
        final FloatsArray data = FloatsArray.copy(mArray);

        mArray[0] = 2.0f;

        assertThat(data.itemAt(0), equalTo(1.0f));
    }
    ...
    public void testItemAt_IndexOutOfBound() {
        FloatsArray.wrap(mArray).itemAt(-1);
    }

    @Test
    public void testLength() {
        assertThat(FloatsArray.wrap(mArray).length(), equalTo(mArray.length));
    }

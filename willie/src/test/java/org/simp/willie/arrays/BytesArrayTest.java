...
public class BytesArrayTest {
    ...
    public void testWrap_UsesSameArray() {
        ...
        final BytesArray data = BytesArray.wrap(mArray);

        mArray[0] = 2;

        assertThat(data.itemAt(0), equalTo((byte) 2));
    }
    ...
    public void testCopy_CreateNewArray() {
        ...
        final BytesArray data = BytesArray.copy(mArray);

        mArray[0] = 2;

        assertThat(data.itemAt(0), equalTo((byte) 1));
    }
    ...
    public void testItemAt_IndexOutOfBound() {
        BytesArray.wrap(mArray).itemAt(-1);
    }

    @Test
    public void testLength() {
        assertThat(BytesArray.wrap(mArray).length(), equalTo(mArray.length));
    }

...
public class IntsArrayTest {
    ...
    public void testWrap_UsesSameArray() {
        ...
        final IntsArray data = IntsArray.wrap(mArray);

        mArray[0] = 2;

        assertThat(data.itemAt(0), equalTo(2));
    }
    ...
    public void testCopy_CreateNewArray() {
        ...
        final IntsArray data = IntsArray.copy(mArray);

        mArray[0] = 2;

        assertThat(data.itemAt(0), equalTo(1));
    }
    ...
    public void testItemAt_IndexOutOfBound() {
        IntsArray.wrap(mArray).itemAt(-1);
    }

    @Test
    public void testLength() {
        assertThat(IntsArray.wrap(mArray).length(), equalTo(mArray.length));
    }

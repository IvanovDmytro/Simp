...
/**
 * Immutable array of {@code String}.
...
public final class StringsArray {
    ...
    /**
     * Creates new instance of {@link StringsArray} by wrapping provided in a parameters array.
     ...
     * @return new instance of {@link StringsArray}
     */
    public static StringsArray wrap(final String... data) {
        if (data == null) {
            throw new IllegalArgumentException("Given array could not be null.");
        }

        return new StringsArray(data);
    }

    /**
     * Creates new instance of {@link StringsArray} by copying provided in a parameters array.
     * Method should be used for most cases of {@link StringsArray} creation.
     * WARNING: creates new instance of given array, might not be efficient for big arrays.
     *
     * @param data array to be copied
     * @return new instance of {@link StringsArray}
     */
    public static StringsArray copy(final String... data) {
        if (data == null) {
            throw new IllegalArgumentException("Given array could not be null.");
        }
        ...
        return new StringsArray(copy);
    }

    @SuppressWarnings("PMD.ArrayIsStoredDirectly")
    private StringsArray(final String[] data) {
        mData = data;
    }

...
/**
 * Immutable array of {@code double}.
 * Does not use autoboxing, threadsafe.
 *
 * @author Dmytro Ivanov
 */
@SuppressWarnings("PMD.UseVarargs")
public final class DoublesArray {
    ...
    /**
     * Creates new instance of {@link DoublesArray} by wrapping provided in a parameters array.
     ...
     * @return new instance of {@link DoublesArray}
     */
    public static DoublesArray wrap(final double... data) {
        if (data == null) {
            throw new IllegalArgumentException("Given array could not be null.");
        }

        return new DoublesArray(data);
    }

    /**
     * Creates new instance of {@link DoublesArray} by copying provided in a parameters array.
     * Method should be used for most cases of {@link DoublesArray} creation.
     * WARNING: creates new instance of given array, might not be efficient for big arrays.
     *
     * @param data array to be copied
     * @return new instance of {@link DoublesArray}
     */
    public static DoublesArray copy(final double... data) {
        if (data == null) {
            throw new IllegalArgumentException("Given array could not be null.");
        }
        ...
        return new DoublesArray(copy);
    }

    @SuppressWarnings("PMD.ArrayIsStoredDirectly")
    private DoublesArray(final double[] data) {
        mData = data;
    }
     ...
     */
    public double itemAt(final int index) {
        return mData[index];
    }
